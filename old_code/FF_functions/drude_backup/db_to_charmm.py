...
def main(argv):
    ...
    fun(option,other_opt,argv,args)
    



def fun(config,other_opt,argv,args):
    ...
    atype_tail = args.atype_tail.split()[0]
    ...
    for i in Data:
      Atom_type_dict,fixed_modes = Write_CHARMM(Filename,Data[i]['Atom_types'],Data[i]['Elements'],Data[i]['Geometry'],Data[i]['Bonds'],Data[i]['Bond_types'],Data[i]['Bond_params'],Data[i]['Angles'],Data[i]['Angle_types'],Data[i]['Angle_params'],\
                                            Data[i]['Dihedrals'],Data[i]['Dihedral_types'],Data[i]['Dihedral_params'],Data[i]['Impropers'],Data[i]['Improper_types'],Data[i]['Improper_params'],Data[i]['Charges'],VDW_params,Data[i]['Masses'],alpha_dict,Data[i]['LP_params'],Improper_flag = improper_flag,polar_flag=polar_flag,LP_flag=lp_flag,overwrite=option['overwrite'],fit_flag=option['fit_flag'],nonC_flag=option['nonC_flag'],onefour_scale=onefour_scale,atype_tail=atype_tail,resname=resname)
