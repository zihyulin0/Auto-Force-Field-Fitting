...
def main(argv):
    ...
    for i in mc_keys:
        ...
        if os.path.isdir('vdw') : 
            ...
            continue
        os.makedirs('vdw')
        subprocess.call("python /depot/bsavoie/data/Lin/taffi_beta/Automation_Scripts/vdw_loop_drude_negishi.py -c ../config.txt -FF /depot/bsavoie/data/Lin/taffi_bumjoon_data/FOM_depth2_012622/depth2_batch5_012522.db -polar_dir /scratch/negishi/lin1209/Drude_0413_caleman/polar_copy -current_gen {}".format(g),shell=True)
        os.chdir('..')
