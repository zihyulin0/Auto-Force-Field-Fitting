...
def fit_charges(g,c,status):
    ...
    for inchi in mc_keys:
        ...
        mdfolders.append('{}/charges'.format(inchi))
        os.chdir('charges')
    ...
    # negishi needs this to make sure all jobs completed
...
def check_lammps_cycle1(mdfolders):
    status = []
    for i in mdfolders:
      logfile = '{}/charges.log'.format(i,i)
