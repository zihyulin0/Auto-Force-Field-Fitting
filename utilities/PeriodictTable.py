class Tables():
    ...
    MAXBONDS = {'H': 2, 'He': 1, \
                     ...
                     'At': None, 'Rn': None}
    MASSDICT = {'H': 1.00794, 'He': 4.002602, 'Li': 6.941, 'Be': 9.012182, 'B': 10.811, 'C': 12.011,
    ...
    ELEMENTDICT = {1: 'H', 2: 'He', 3: 'Li', 4: 'Be', 5: 'B', 6: 'C', 7: 'N', 8: 'O', 9: 'F', 10: 'Ne', \
    ...
    PERIODICT = {"h": 1, "he": 2, \
                     ...
                     "rn": 86}
    ELETRONEGATIVITY = {"h": 2.3, "he": 4.16, \
    ...
    Remove 6-16-1:73
    """
    BOND_ENERGY = {"6-6-1": 63, "6-6-2": 117, "6-7-1": 74, "6-7-2": 140, "6-8-1": 92.5, "6-8-2": 172.5,
